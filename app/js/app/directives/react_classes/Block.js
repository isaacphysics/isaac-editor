define(["react", "jquery"], function(React,$) {
	return function(ContentEditor, typeMap, MetaData, Title, JSONEditor) {
		...
		var displayMetadataForTypes = ["page", "isaacPod", "isaacCard", "isaacCardDeck", "emailTemplate", "isaacQuestionPage", "isaacFastTrackQuestionPage", "isaacConceptPage", "isaacTopicSummaryPage", "isaacWildcard", "figure", "isaacEventPage", "isaacPageFragment", "anvilApp"];
